...
Elm.Elmsweep = Elm.Elmsweep || {};
Elm.Elmsweep.make = function (_elm) {
   "use strict";
   _elm.Elmsweep = _elm.Elmsweep || {};
   if (_elm.Elmsweep.values) return _elm.Elmsweep.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var split = F2(function (n,lls) {
      var _p1 = lls;
      if (_p1.ctor === "::") {
            return A2($List._op["::"],
            A2($List.take,n,lls),
            A2(split,n,A2($List.drop,n,lls)));
         } else {
            return _U.list([]);
         }
   });
   var getCell = F2(function (p,_p2) {
      var _p3 = _p2;
      return A2($Array.get,p,_p3._2);
   });
   var fieldClass = function (str) {
      return _U.eq(str,
      "B") ? $Html$Attributes.$class("esw-noselect esw-bomb") : _U.eq(str,
      "F") ? $Html$Attributes.$class("esw-noselect esw-flag") : _U.eq(str,
   ...
   var fieldString = F3(function (done,won,c) {
      var _p4 = {ctor: "_Tuple5"
                ,_0: c.seen
                ,_1: c.safe
                ,_2: c.flag
                ,_3: done
   ...
   var statusString = F2(function (won,lost) {
      return won ? ":D" : lost ? ":(" : ":)";
   });
   var screen = function (str) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("esw-screen")]),
      _U.list([A2($Html.span,
      _U.list([$Html$Attributes.$class("esw-noselect")]),
      _U.list([$Html.text(str)]))]));
   };
   var adjacent = F2(function (i,_p5) {
      var _p6 = _p5;
      var _p13 = _p6._0;
      var adj = F2(function (x,y) {
         return _U.list([{ctor: "_Tuple2",_0: x + 1,_1: y}
      ...
      var arrayIndex = F2(function (w,_p7) {
         var _p8 = _p7;
         return _p8._0 + _p8._1 * w;
      });
      var y = i / _p13 | 0;
      var x = A2($Basics.rem,i,_p13);
      return A2($List.map,
      arrayIndex(_p13),
      A2($List.filter,
      function (_p9) {
         ...
         var _p12 = _p10._1;
         var _p11 = _p10._0;
         return _U.cmp(_p11,0) > -1 && (_U.cmp(_p11,
         _p13) < 0 && (_U.cmp(_p12,0) > -1 && _U.cmp(_p12,_p6._1) < 0));
      },
      A2(adj,x,y)));
   });
   var adjacentCells = F2(function (p,bo) {
   ...
   var canShowAdjacent = F2(function (p,bo) {
      var _p14 = A2(getCell,p,bo);
      if (_p14.ctor === "Just") {
   ...
   var height = function (_p17) {
      var _p18 = _p17;
      return _p18._1;
   };
   var width = function (_p19) {
      var _p20 = _p19;
      return _p20._0;
   };
   var randomMineIndices = F3(function (n,gen,seed) {
      var go = F3(function (m,seed0,acc) {
         go: while (true) if (_U.eq(m,n)) return {ctor: "_Tuple2"
                                                 ,_0: $Set.toList(acc)
                                                 ,_1: seed0}; else {
               var _p21 = A2($Random.generate,gen,seed0);
               var i = _p21._0;
               var seed1 = _p21._1;
               if (A2($Set.member,i,acc)) {
                     var _v10 = m,_v11 = seed1,_v12 = acc;
                     m = _v10;
                     seed0 = _v11;
                     acc = _v12;
                     continue go;
                  } else {
                     var _v13 = m + 1,_v14 = seed1,_v15 = A2($Set.insert,i,acc);
                     m = _v13;
                     seed0 = _v14;
                     acc = _v15;
                     continue go;
      ...
      return A3(go,0,seed,$Set.empty);
   });
   var randomMines = F4(function (w,h,n,seed) {
      var gen = A2($Random.$int,0,w * h - 1);
      var _p22 = A3(randomMineIndices,n,gen,seed);
      var ns = _p22._0;
      var seed0 = _p22._1;
      var bs = A2($List.indexedMap,
      F2(function (i,b) {    return A2($List.member,i,ns);}),
      A2($List.repeat,w * h,false));
      return {ctor: "_Tuple2",_0: seed0,_1: bs};
   });
   ...
   var Board = F3(function (a,b,c) {
      return {ctor: "Board",_0: a,_1: b,_2: c};
   });
   var updateCell = F3(function (p,f,bo) {
      var _p23 = bo;
      var _p25 = _p23._2;
      var _p24 = A2($Array.get,p,_p25);
      if (_p24.ctor === "Just") {
            return A3(Board,
            _p23._0,
            _p23._1,
            A3($Array.set,p,f(_p24._0),_p25));
         } else {
            return bo;
         }
   });
   var showCell = F2(function (p,bo) {
      return A3(updateCell,
      p,
      function (c) {
         return $Basics.not(c.flag) ? _U.update(c,{seen: true}) : c;
      },
      bo);
   });
   var updateShowCascadeCell = F2(function (p,bo) {
      var _p26 = A2(getCell,p,bo);
      if (_p26.ctor === "Just") {
            var _p27 = _p26._0;
            return $Basics.not(_p27.seen) && $Basics.not(_p27.flag) ? _U.eq(_p27.adj,
            0) ? {ctor: "_Tuple2"
                 ,_0: A2(showCell,p,bo)
                 ,_1: A2(adjacent,p,bo)} : {ctor: "_Tuple2"
                                           ,_0: A2(showCell,p,bo)
                                           ,_1: _U.list([])} : {ctor: "_Tuple2",_0: bo,_1: _U.list([])};
         } else {
            return {ctor: "_Tuple2",_0: bo,_1: _U.list([])};
         }
   });
   var updateShowCascade = F3(function (acc,set,bo) {
      updateShowCascade: while (true) {
         var _p28 = acc;
         if (_p28.ctor === "::") {
               var _p29 = A2(updateShowCascadeCell,_p28._0,bo);
               var bo0 = _p29._0;
               var acc0 = _p29._1;
               var acx = A2($List.filter,
               function (p0) {
                  return A2($Set.member,p0,set);
               },
               acc0);
               var _p30 = A3($List.foldl,
               F2(function (p0,_p31) {
                  var _p32 = _p31;
                  var _p33 = A2(updateShowCascadeCell,p0,_p32._0);
                  return {ctor: "_Tuple2"
                         ,_0: _p33._0
                         ,_1: A2($List.append,_p33._1,_p32._1)};
               }),
               {ctor: "_Tuple2",_0: bo0,_1: _U.list([])},
               acx);
               var bo1 = _p30._0;
               var acc1 = _p30._1;
               var accn = A2($List.append,acc0,acc1);
               var $new = A2($Set.diff,$Set.fromList(accn),set);
               var _v22 = A2($List.append,_p28._1,$Set.toList($new)),
               _v23 = A2($Set.union,$new,set),
               _v24 = bo1;
               acc = _v22;
               set = _v23;
               bo = _v24;
               continue updateShowCascade;
            } else {
               return bo;
            }
      }
   });
   var updateShow = F2(function (ps,bo) {
      var cs = A2($List.filter,
      function (_p34) {
         var _p35 = _p34;
         var _p36 = _p35._1;
         return $Basics.not(_p36.seen) && $Basics.not(_p36.flag);
      },
      A2($List.filterMap,
      function (p) {
         return A2($Maybe.map,
      ...
      function (_p37) {
         var _p38 = _p37;
         return _U.eq(_p38._1.adj,0) ? A2(adjacent,
         _p38._0,
         bo) : _U.list([]);
      },
      cs));
      var bo0 = A3($List.foldl,
      F2(function (_p39,bo1) {
         var _p40 = _p39;
         return A2(showCell,_p40._0,bo1);
      }),
      bo,
      cs);
      ...
      function (_p41) {
         var _p42 = _p41;
         return $Basics.not(_p42._1.safe);
      },
      cs);
      return done ? bo0 : A3(updateShowCascade,
      $Set.toList($Set.fromList(adj)),
      $Set.empty,
      bo0);
   });
   var updateClick = F3(function (cmd,p,bo) {
      var _p43 = cmd;
      switch (_p43.ctor)
      {case "Show": return A2(updateShow,_U.list([p]),bo);
         case "Flag": return A3(updateCell,
           p,
           function (c) {
              return _U.update(c,
              {flag: $Basics.not(c.flag) && $Basics.not(c.seen)});
           },
           bo);
         default: return A2(updateShow,
           A2($List.filter,
           function (p) {
              var _p44 = A2(getCell,p,bo);
              if (_p44.ctor === "Just") {
                    var _p45 = _p44._0;
                    return $Basics.not(_p45.seen || _p45.flag);
                 } else {
                    return false;
                 }
           },
   ...
   var Cell = F4(function (a,b,c,d) {
      return {flag: a,seen: b,safe: c,adj: d};
   });
   var makeBoard = F3(function (w,h,mines) {
      var three = F2(function (n,ls) {
         return A2($List.drop,n - 1,A2($List.take,n + 2,ls));
      });
      var adjMines = F3(function (x,y,bo) {
         return $List.length($Basics.fst(A2($List.partition,
         $Basics.identity,
         $List.concat(A2(three,y,A2($List.map,three(x),bo))))));
      });
      var rows = A2(split,w,mines);
      var makeCell = F3(function (x,y,mine) {
         return A4(Cell,
         false,
         false,
         $Basics.not(mine),
         A3(adjMines,x,y,rows));
      });
      var bo = A2($List.indexedMap,
      F2(function (y,row) {
         return A2($List.indexedMap,
         F2(function (x,mine) {    return A3(makeCell,x,y,mine);}),
         row);
      }),
      rows);
      return A3(Board,w,h,$Array.fromList($List.concat(bo)));
   });
   var makeNewBoard = F2(function (w,h) {
      return A3(makeBoard,w,h,A2($List.repeat,w * h,true));
   });
   var Lost = {ctor: "Lost"};
   var gameLost = function (gs) {
      return _U.eq(gs.status,Lost);
   };
   var Won = {ctor: "Won"};
   var gameWon = function (gs) {    return _U.eq(gs.status,Won);};
   var Play = {ctor: "Play"};
   var makeNewGame = F4(function (w,h,n,seed) {
      return A7(GameState,
      0,
      0,
      A2(makeNewBoard,w,h),
   ...
   var defaultGame = A4(makeNewGame,0,0,0,0);
   var randomGame = function (gs) {
      var bo = gs.board;
      var w = width(bo);
      var h = height(bo);
      var _p46 = A4(randomMines,w,h,gs.nmine,gs.seed);
      var seed = _p46._0;
      var mines = _p46._1;
      return _U.update(gs,
      {board: A3(makeBoard,w,h,mines)
      ,timeStart: 0
      ,timeReached: 0
      ,seed: seed
      ,status: Play
   ...
   var gameDone = function (gs) {
      return !_U.eq(gs.status,Play);
   };
   var status = function (_p47) {
      var _p48 = _p47;
      var _p49 = _p48._2;
   ...
   var ShowAdjacent = function (a) {
      return {ctor: "ShowAdjacent",_0: a};
   };
   var Show = function (a) {    return {ctor: "Show",_0: a};};
   var Flag = function (a) {    return {ctor: "Flag",_0: a};};
   var update = F2(function (cmd,gs) {
      if (gameDone(gs)) {
            var _p50 = cmd;
            _v32_2: do {
               switch (_p50.ctor)
               {case "Restart": return randomGame(gs);
                  case "InitGame": if (_p50._0.ctor === "_Tuple4") {
                          return randomGame(A4(makeNewGame,
                          _p50._0._0,
                          _p50._0._1,
                          _p50._0._2,
                          _p50._0._3));
                  ...
                  default: break _v32_2;}
            } while (false);
            return _U.update(gs,{sent: true});
         } else {
            var _p51 = cmd;
            _v33_6: do {
               switch (_p51.ctor)
               {case "Click": switch (_p51._1.ctor)
                    {case "Show": if (_p51._0.ctor === "Just") {
                               var _p53 = _p51._0._0;
                               var _p52 = _p51._1._0;
                               var gs0 = _U.eq(gs.timeStart,0) ? _U.update(gs,
                               {timeReached: _p53,timeStart: _p53}) : gs;
                               var bo0 = A3(updateClick,Show(_p52),_p52,gs0.board);
                               return _U.update(gs0,{board: bo0,status: status(bo0)});
                            } else {
                               break _v33_6;
                            }
                       case "Flag": var _p54 = _p51._1._0;
                         var bo0 = A3(updateClick,Flag(_p54),_p54,gs.board);
                         return _U.update(gs,{board: bo0,status: status(bo0)});
                       default: var _p55 = _p51._1._0;
                         if (A2(canShowAdjacent,_p55,gs.board)) {
                               var bo0 = A3(updateClick,ShowAdjacent(_p55),_p55,gs.board);
                               return _U.update(gs,{board: bo0,status: status(bo0)});
                            } else return gs;}
                  case "Restart": return randomGame(gs);
                  case "InitGame": if (_p51._0.ctor === "_Tuple4") {
                          return randomGame(A4(makeNewGame,
                          _p51._0._0,
                          _p51._0._1,
                          _p51._0._2,
                  ...
                  default: return _U.eq(gs.timeStart,0) ? gs : _U.update(gs,
                    {timeReached: _p51._0});}
            } while (false);
            return gs;
         }
   });
   var InitGame = function (a) {
      return {ctor: "InitGame",_0: a};
   };
   var Restart = {ctor: "Restart"};
   var Timer = function (a) {    return {ctor: "Timer",_0: a};};
   var Click = F2(function (a,b) {
      return {ctor: "Click",_0: a,_1: b};
   });
   var flag = function (i) {
      return A2(Click,$Maybe.Nothing,Flag(i));
   };
   var show = function (i) {
      return A2(Click,$Maybe.Nothing,Show(i));
   };
   var showAdjacent = function (i) {
      return A2(Click,$Maybe.Nothing,ShowAdjacent(i));
   };
   var click = function (_p56) {
      var _p57 = _p56;
      var _p59 = _p57._1;
      var _p58 = _p59;
      if (_p58.ctor === "Click") {
            return A2(Click,$Maybe.Just(_p57._0),_p58._1);
         } else {
            return _p59;
         }
   };
   var clicks = function (s) {    return A2($Signal.map,click,s);};
   var times = A2($Signal.map,Timer,$Time.every(1 * $Time.second));
   var commands = $Signal.mailbox(Restart);
   var statusScreen = function (str) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("esw-status")
              ,A2($Html$Events.onClick,commands.address,Restart)]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("esw-rotate-90")]),
      _U.list([A2($Html.span,
      _U.list([$Html$Attributes.$class("esw-noselect")]),
      _U.list([$Html.text(str)]))]))]));
   };
   var button = F4(function (i,done,won,c) {
      var str = A3(fieldString,done,won,c);
      var down = !_U.eq(str,"");
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(down ? "esw-cell esw-cell-down" : "esw-cell esw-cell-up")
              ,A2($Html$Events.onClick,commands.address,show(i))
              ,A3(messageOn,"dblclick",commands.address,showAdjacent(i))
              ,A3(messageOn,"contextmenu",commands.address,flag(i))]),
      _U.list([A2($Html.span,
      _U.list([fieldClass(str)]),
      _U.list([$Html.text(_U.eq(str,"0") || (_U.eq(str,
      "B") || (_U.eq(str,"W") || (_U.eq(str,"F") || _U.eq(str,
      "X")))) ? "" : str)]))]));
   });
   var display = function (gs) {
      var time = $Basics.toString($Basics.round($Time.inSeconds(gs.timeReached - gs.timeStart)));
      var flagsUsed = function (bo) {
      ...
      var h = _p60._1;
      var arr = _p60._2;
      var flag = $Basics.toString(_U.eq(gs.timeReached,
      0) ? gs.nmine : gs.nmine - flagsUsed(arr));
      var rows = A2(split,w,$Array.toIndexedList(arr));
      return _U.eq(gs.nmine,0) ? $Html.text("") : A2($Html.div,
      _U.list([$Html$Attributes.$class("esw-table")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("esw-status")]),
              _U.list([screen(time)
                      ,statusScreen(A2(statusString,won,lost))
                      ,screen(flag)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("esw-rows")]),
              A2($List.map,
              function (row) {
                 return A2($Html$Lazy.lazy,
                 function (row0) {
                    return A2($Html.div,
                    _U.list([$Html$Attributes.$class("esw-row esw-noselect")]),
                    A2($List.map,
                    function (_p61) {
                       var _p62 = _p61;
                       return A4(button,_p62._0,done,won,_p62._1);
                    },
                    row0));
                 },
                 row);
   ...
   var initGame = Elm.Native.Port.make(_elm).inboundSignal("initGame",
   "( Int, Int, Int, Int )",
   function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple4"
                                                           ...
                                                           v[1])
                                                           ,_2: typeof v[2] === "number" && isFinite(v[2]) && Math.floor(v[2]) === v[2] ? v[2] : _U.badPort("an integer",
                                                           v[2])
                                                           ,_3: typeof v[3] === "number" && isFinite(v[3]) && Math.floor(v[3]) === v[3] ? v[3] : _U.badPort("an integer",
                                                           v[3])} : _U.badPort("an array",v);
   });
   var gameStates = A3($Signal.foldp,
   update,
   defaultGame,
   $Signal.mergeMany(_U.list([A2($Signal.map,InitGame,initGame)
                             ,clicks($Time.timestamp(commands.signal))
                             ,times])));
   var wonGame = Elm.Native.Port.make(_elm).outboundSignal("wonGame",
   function (v) {
   ...
   A3($Signal.filter,
   function (gs) {
      return $Basics.not(gs.sent) && _U.eq(gs.status,Won);
   },
   defaultGame,
   gameStates)));
   var main = A2($Signal.map,display,gameStates);
   return _elm.Elmsweep.values = {_op: _op
                                 ,main: main
                                 ...
                                 ,randomMineIndices: randomMineIndices
